import { h as Jt, defineComponent as We, ref as G, computed as Dt, resolveComponent as te, openBlock as Ct, createBlock as Bt, resolveDynamicComponent as ee, mergeProps as At, withCtx as _t, createElementVNode as H, createVNode as Mt, withDirectives as kt, vShow as It, toDisplayString as ie, createElementBlock as Xe, Fragment as Ue, renderList as je, normalizeClass as Ve } from "vue";
import { useUi as $e, useI18n as Fe } from "@fast-crud/fast-crud";
import { _ as Ge } from "./index-d86da30d.mjs";
import "lodash-es";
/*!
 * Cropper.js v1.6.2
...
function we(a) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2 ? ae(Object(i), !0).forEach(function(e) {
      Ke(a, e, i[e]);
...
function re(a, t) {
  for (var i = 0; i < t.length; i++) {
    var e = t[i];
    e.enumerable = e.enumerable || !1, e.configurable = !0, "value" in e && (e.writable = !0), Object.defineProperty(a, ye(e.key), e);
  }
}
function qe(a, t, i) {
...
var Nt = typeof window < "u" && typeof window.document < "u", V = Nt ? window : {}, Gt = Nt && V.document.documentElement ? "ontouchstart" in V.document.documentElement : !1, Qt = Nt ? "PointerEvent" in V : !1, C = "cropper", Zt = "all", De = "crop", Ce = "move", Me = "zoom", J = "e", tt = "w", rt = "s", Q = "n", ut = "ne", ft = "nw", dt = "se", gt = "sw", Yt = "".concat(C, "-crop"), oe = "".concat(C, "-disabled"), I = "".concat(C, "-hidden"), ne = "".concat(C, "-hide"), ai = "".concat(C, "-invisible"), Ot = "".concat(C, "-modal"), Wt = "".concat(C, "-move"), vt = "".concat(C, "Action"), Et = "".concat(C, "Preview"), qt = "crop", Ee = "move", Te = "none", Xt = "crop", Ut = "cropend", jt = "cropmove", Vt = "cropstart", se = "dblclick", ri = Gt ? "touchstart" : "mousedown", oi = Gt ? "touchmove" : "mousemove", ni = Gt ? "touchend touchcancel" : "mouseup", he = Qt ? "pointerdown" : ri, ce = Qt ? "pointermove" : oi, le = Qt ? "pointerup pointercancel" : ni, pe = "ready", ue = "resize", fe = "wheel", $t = "zoom", de = "image/jpeg", si = /^e|w|s|n|se|sw|ne|nw|all|crop|move|zoom$/, hi = /^data:/, ci = /^data:image\/jpeg;base64,/, li = /^img|canvas$/i, Oe = 200, Ne = 100, ge = {
  ...
  crop: null,
  zoom: null
}, pi = '<div class="cropper-container" touch-action="none"><div class="cropper-wrap-box"><div class="cropper-canvas"></div></div><div class="cropper-drag-box"></div><div class="cropper-crop-box"><span class="cropper-view-box"></span><span class="cropper-dashed dashed-h"></span><span class="cropper-dashed dashed-v"></span><span class="cropper-center"></span><span class="cropper-face"></span><span class="cropper-line line-e" data-cropper-action="e"></span><span class="cropper-line line-n" data-cropper-action="n"></span><span class="cropper-line line-w" data-cropper-action="w"></span><span class="cropper-line line-s" data-cropper-action="s"></span><span class="cropper-point point-e" data-cropper-action="e"></span><span class="cropper-point point-n" data-cropper-action="n"></span><span class="cropper-point point-w" data-cropper-action="w"></span><span class="cropper-point point-s" data-cropper-action="s"></span><span class="cropper-point point-ne" data-cropper-action="ne"></span><span class="cropper-point point-nw" data-cropper-action="nw"></span><span class="cropper-point point-sw" data-cropper-action="sw"></span><span class="cropper-point point-se" data-cropper-action="se"></span></div></div>', ui = Number.isNaN || V.isNaN;
function v(a) {
...
function xi(a) {
  ...
  return N(a, function(e, n) {
    delete t[n], N(t, function(r) {
      var o = Math.abs(e.startX - r.startX), s = Math.abs(e.startY - r.startY), p = Math.abs(e.endX - r.endX), l = Math.abs(e.endY - r.endY), h = Math.sqrt(o * o + s * s), c = Math.sqrt(p * p + l * l), u = (c - h) / h;
...
function Mi(a, t, i, e) {
  var n = t.aspectRatio, r = t.naturalWidth, o = t.naturalHeight, s = t.rotate, p = s === void 0 ? 0 : s, l = t.scaleX, h = l === void 0 ? 1 : l, c = t.scaleY, u = c === void 0 ? 1 : c, g = i.aspectRatio, m = i.naturalWidth, y = i.naturalHeight, b = e.fillColor, E = b === void 0 ? "transparent" : b, O = e.imageSmoothingEnabled, x = O === void 0 ? !0 : O, z = e.imageSmoothingQuality, B = z === void 0 ? "low" : z, f = e.maxWidth, w = f === void 0 ? 1 / 0 : f, T = e.maxHeight, A = T === void 0 ? 1 / 0 : T, L = e.minWidth, $ = L === void 0 ? 0 : L, W = e.minHeight, P = W === void 0 ? 0 : W, _ = document.createElement("canvas"), R = _.getContext("2d"), F = q({
    aspectRatio: g,
    width: w,
    height: A
  }), K = q({
  ...
  return _.width = st(it), _.height = st(ct), R.fillStyle = E, R.fillRect(0, 0, it, ct), R.save(), R.translate(it / 2, ct / 2), R.rotate(p * Math.PI / 180), R.scale(h, u), R.imageSmoothingEnabled = x, R.imageSmoothingQuality = B, R.drawImage.apply(R, [a].concat(xe(St.map(function(Rt) {
...
var Bi = {
  ...
  initCanvas: function() {
    ...
    this.canvasData = h, this.limited = e === 1 || e === 2, this.limitCanvas(!0, !0), h.width = Math.min(Math.max(h.width, h.minWidth), h.maxWidth), h.height = Math.min(Math.max(h.height, h.minHeight), h.maxHeight), h.left = (t.width - h.width) / 2, h.top = (t.height - h.height) / 2, h.oldLeft = h.left, h.oldTop = h.top, this.initialCanvasData = M({}, h);
  },
  limitCanvas: function(t, i) {
    ...
    if (t) {
      ...
      s > 1 ? (h = Math.max(h, n.width), c = Math.max(c, n.height), s === 3 && (c * p > h ? h = c * p : c = h / p)) : s > 0 && (h ? h = Math.max(h, l ? o.width : 0) : c ? c = Math.max(c, l ? o.height : 0) : l && (h = o.width, c = o.height, c * p > h ? h = c * p : c = h / p));
      var u = q({
        aspectRatio: p,
        width: h,
        height: c
      });
      h = u.width, c = u.height, r.minWidth = h, r.minHeight = c, r.maxWidth = 1 / 0, r.maxHeight = 1 / 0;
    }
    if (i)
      if (s > (l ? 0 : 1)) {
  ...
  renderCanvas: function(t, i) {
    ...
    if (i) {
      ...
      e.left -= (p - e.width) / 2, e.top -= (l - e.height) / 2, e.width = p, e.height = l, e.aspectRatio = o / s, e.naturalWidth = o, e.naturalHeight = s, this.limitCanvas(!0, !1);
    }
    (e.width > e.maxWidth || e.width < e.minWidth) && (e.left = e.oldLeft), (e.height > e.maxHeight || e.height < e.minHeight) && (e.top = e.oldTop), e.width = Math.min(Math.max(e.width, e.minWidth), e.maxWidth), e.height = Math.min(Math.max(e.height, e.minHeight), e.maxHeight), this.limitCanvas(!1, !0), e.left = Math.min(Math.max(e.left, e.minLeft), e.maxLeft), e.top = Math.min(Math.max(e.top, e.minTop), e.maxTop), e.oldLeft = e.left, e.oldTop = e.top, Z(this.canvas, M({
      width: e.width,
      height: e.height
    }, mt({
      translateX: e.left,
  ...
  initCropBox: function() {
    ...
    e && (i.height * e > i.width ? r.height = r.width / e : r.width = r.height * e), this.cropBoxData = r, this.limitCropBox(!0, !0), r.width = Math.min(Math.max(r.width, r.minWidth), r.maxWidth), r.height = Math.min(Math.max(r.height, r.minHeight), r.maxHeight), r.width = Math.max(r.minWidth, r.width * n), r.height = Math.max(r.minHeight, r.height * n), r.left = i.left + (i.width - r.width) / 2, r.top = i.top + (i.height - r.height) / 2, r.oldLeft = r.left, r.oldTop = r.top, this.initialCropBoxData = M({}, r);
  },
  limitCropBox: function(t, i) {
    ...
    if (t) {
      var l = Number(e.minCropBoxWidth) || 0, h = Number(e.minCropBoxHeight) || 0, c = s ? Math.min(n.width, r.width, r.width + r.left, n.width - r.left) : n.width, u = s ? Math.min(n.height, r.height, r.height + r.top, n.height - r.top) : n.height;
      l = Math.min(l, n.width), h = Math.min(h, n.height), p && (l && h ? h * p > l ? h = l / p : l = h * p : l ? h = l / p : h && (l = h * p), u * p > c ? u = c / p : c = u * p), o.minWidth = Math.min(l, c), o.minHeight = Math.min(h, u), o.maxWidth = c, o.maxHeight = u;
    }
  ...
  renderCropBox: function() {
    ...
    (e.width > e.maxWidth || e.width < e.minWidth) && (e.left = e.oldLeft), (e.height > e.maxHeight || e.height < e.minHeight) && (e.top = e.oldTop), e.width = Math.min(Math.max(e.width, e.minWidth), e.maxWidth), e.height = Math.min(Math.max(e.height, e.minHeight), e.maxHeight), this.limitCropBox(!1, !0), e.left = Math.min(Math.max(e.left, e.minLeft), e.maxLeft), e.top = Math.min(Math.max(e.top, e.minTop), e.maxTop), e.oldLeft = e.left, e.oldTop = e.top, t.movable && t.cropBoxMovable && bt(this.face, vt, e.width >= i.width && e.height >= i.height ? Ce : Zt), Z(this.cropBox, M({
      width: e.width,
      height: e.height
    }, mt({
      translateX: e.left,
  ...
  preview: function() {
    ...
    !this.cropped || this.disabled || (Z(this.viewBoxImage, M({
      ...
      translateX: -p,
      translateY: -l
    }, t)))), N(this.previews, function(h) {
      var c = Ft(h, Et), u = c.width, g = c.height, m = u, y = g, b = 1;
      n && (b = u / n, y = r * b), r && y > g && (b = g / r, m = n * b, y = g), Z(h, {
        width: m,
        height: y
      }), Z(h.getElementsByTagName("img")[0], M({
        width: o * b,
        height: s * b
      }, mt(M({
        translateX: -p * b,
  ...
  resize: function() {
    if (!this.disabled) {
      ...
      if (o !== 1) {
        var s, p;
        t.restore && (s = this.getCanvasData(), p = this.getCropBoxData()), this.render(), t.restore && (this.setCanvasData(N(s, function(l, h) {
          s[h] = l * o;
        })), this.setCropBoxData(N(p, function(l, h) {
          p[h] = l * o;
        })));
      }
    }
  ...
  cropStart: function(t) {
    ...
    (v(i) && i !== 1 || v(e) && e !== 0 || t.ctrlKey))) {
      ...
      t.changedTouches ? N(t.changedTouches, function(s) {
        ...
        originalEvent: t,
        action: o
      }) !== !1 && (t.preventDefault(), this.action = o, this.cropping = !1, o === De && (this.cropping = !0, S(this.dragBox, Ot)));
    }
  },
  cropMove: function(t) {
    var i = this.action;
    if (!(this.disabled || !i)) {
      ...
      t.preventDefault(), ht(this.element, jt, {
        originalEvent: t,
        action: i
      }) !== !1 && (t.changedTouches ? N(t.changedTouches, function(n) {
        M(e[n.identifier] || {}, Tt(n, !0));
      }) : M(e[t.pointerId || 0] || {}, Tt(t, !0)), this.change(t));
    }
  },
  cropEnd: function(t) {
    if (!this.disabled) {
      ...
      }) : delete e[t.pointerId || 0], i && (t.preventDefault(), Object.keys(e).length || (this.action = ""), this.cropping && (this.cropping = !1, nt(this.dragBox, Ot, this.cropped && this.options.modal)), ht(this.element, Ut, {
        originalEvent: t,
        action: i
      }));
    }
  ...
  change: function(t) {
    var i = this.options, e = this.canvasData, n = this.containerData, r = this.cropBoxData, o = this.pointers, s = this.action, p = i.aspectRatio, l = r.left, h = r.top, c = r.width, u = r.height, g = l + c, m = h + u, y = 0, b = 0, E = n.width, O = n.height, x = !0, z;
    ...
    switch (s) {
      case Zt:
        ...
        break;
      case J:
        if (f.x >= 0 && (g >= E || p && (h <= b || m >= O))) {
          x = !1;
          break;
        }
        w(J), c += f.x, c < 0 && (s = tt, c = -c, l -= c), p && (u = c / p, h += (r.height - u) / 2);
        break;
      case Q:
        if (f.y <= 0 && (h <= b || p && (l <= y || g >= E))) {
          x = !1;
          break;
        }
        w(Q), u -= f.y, h += f.y, u < 0 && (s = rt, u = -u, h -= u), p && (c = u * p, l += (r.width - c) / 2);
        break;
      case tt:
        if (f.x <= 0 && (l <= y || p && (h <= b || m >= O))) {
          x = !1;
          break;
        }
        w(tt), c -= f.x, l += f.x, c < 0 && (s = J, c = -c, l -= c), p && (u = c / p, h += (r.height - u) / 2);
        break;
      case rt:
        ...
        w(rt), u += f.y, u < 0 && (s = Q, u = -u, h -= u), p && (c = u * p, l += (r.width - c) / 2);
        break;
      case ut:
        if (p) {
          if (f.y <= 0 && (h <= b || g >= E)) {
          ...
          w(Q), u -= f.y, h += f.y, c = u * p;
        } else
          w(Q), w(J), f.x >= 0 ? g < E ? c += f.x : f.y <= 0 && h <= b && (x = !1) : c += f.x, f.y <= 0 ? h > b && (u -= f.y, h += f.y) : (u -= f.y, h += f.y);
        c < 0 && u < 0 ? (s = gt, u = -u, c = -c, h -= u, l -= c) : c < 0 ? (s = ft, c = -c, l -= c) : u < 0 && (s = dt, u = -u, h -= u);
        break;
      case ft:
        if (p) {
          if (f.y <= 0 && (h <= b || l <= y)) {
          ...
          w(Q), u -= f.y, h += f.y, c = u * p, l += r.width - c;
        } else
          w(Q), w(tt), f.x <= 0 ? l > y ? (c -= f.x, l += f.x) : f.y <= 0 && h <= b && (x = !1) : (c -= f.x, l += f.x), f.y <= 0 ? h > b && (u -= f.y, h += f.y) : (u -= f.y, h += f.y);
        c < 0 && u < 0 ? (s = dt, u = -u, c = -c, h -= u, l -= c) : c < 0 ? (s = ut, c = -c, l -= c) : u < 0 && (s = gt, u = -u, h -= u);
        break;
      case gt:
        if (p) {
          if (f.x <= 0 && (l <= y || m >= O)) {
          ...
          w(rt), w(tt), f.x <= 0 ? l > y ? (c -= f.x, l += f.x) : f.y >= 0 && m >= O && (x = !1) : (c -= f.x, l += f.x), f.y >= 0 ? m < O && (u += f.y) : u += f.y;
        c < 0 && u < 0 ? (s = ut, u = -u, c = -c, h -= u, l -= c) : c < 0 ? (s = dt, c = -c, l -= c) : u < 0 && (s = ft, u = -u, h -= u);
        break;
      case dt:
        if (p) {
          if (f.x >= 0 && (g >= E || m >= O)) {
          ...
          w(rt), w(J), f.x >= 0 ? g < E ? c += f.x : f.y >= 0 && m >= O && (x = !1) : c += f.x, f.y >= 0 ? m < O && (u += f.y) : u += f.y;
        c < 0 && u < 0 ? (s = ft, u = -u, c = -c, h -= u, l -= c) : c < 0 ? (s = gt, c = -c, l -= c) : u < 0 && (s = ut, u = -u, h -= u);
        break;
      case Ce:
        this.move(f.x, f.y), x = !1;
        break;
      case Me:
        this.zoom(xi(o), t), x = !1;
        break;
      case De:
        if (!f.x || !f.y) {
          x = !1;
        ...
        z = Ae(this.cropper), l = B.startX - z.left, h = B.startY - z.top, c = r.minWidth, u = r.minHeight, f.x > 0 ? s = f.y > 0 ? dt : ut : f.x < 0 && (l -= c, s = f.y > 0 ? gt : ft), f.y < 0 && (h -= u), this.cropped || (j(this.cropBox, I), this.cropped = !0, this.limited && this.limitCropBox(!0, !0));
        break;
    }
    x && (r.width = c, r.height = u, r.left = l, r.top = h, this.action = s, this.renderCropBox()), N(o, function(T) {
  ...
  crop: function() {
    return this.ready && !this.cropped && !this.disabled && (this.cropped = !0, this.limitCropBox(!0, !0), this.options.modal && S(this.dragBox, Ot), j(this.cropBox, I), this.setCropBoxData(this.initialCropBoxData)), this;
  },
  ...
  clear: function() {
    return this.cropped && !this.disabled && (M(this.cropBoxData, {
      ...
      width: 0,
      height: 0
    }), this.cropped = !1, this.renderCropBox(), this.limitCanvas(!0, !0), this.renderCanvas(), j(this.dragBox, Ot), S(this.cropBox, I)), this;
  },
  /**
  ...
  enable: function() {
    return this.ready && this.disabled && (this.disabled = !1, j(this.cropper, oe)), this;
  },
  // Disable (freeze) the cropper
  disable: function() {
    return this.ready && !this.disabled && (this.disabled = !0, S(this.cropper, oe)), this;
  },
  /**
  ...
  zoomTo: function(t, i, e) {
    ...
    if (t = Number(t), t >= 0 && this.ready && !this.disabled && n.zoomable) {
      ...
      if (e) {
        ...
        r.left -= (h - o) * ((m.pageX - g.left - r.left) / o), r.top -= (c - s) * ((m.pageY - g.top - r.top) / s);
      } else
        ot(i) && v(i.x) && v(i.y) ? (r.left -= (h - o) * ((i.x - r.left) / o), r.top -= (c - s) * ((i.y - r.top) / s)) : (r.left -= (h - o) / 2, r.top -= (c - s) / 2);
  ...
  setCanvasData: function(t) {
    ...
    return this.ready && !this.disabled && ot(t) && (v(t.left) && (i.left = t.left), v(t.top) && (i.top = t.top), v(t.width) ? (i.width = t.width, i.height = t.width / e) : v(t.height) && (i.height = t.height, i.width = t.height * e), this.renderCanvas(!0)), this;
  },
  /**
  ...
  setCropBoxData: function(t) {
    ...
    return this.ready && this.cropped && !this.disabled && ot(t) && (v(t.left) && (i.left = t.left), v(t.top) && (i.top = t.top), v(t.width) && t.width !== i.width && (n = !0, i.width = t.width), v(t.height) && t.height !== i.height && (r = !0, i.height = t.height), e && (n ? i.height = i.width / e : r && (i.width = i.height * e)), this.renderCropBox()), this;
  },
  /**
  ...
  getCroppedCanvas: function() {
    ...
    var O = t.imageSmoothingEnabled, x = O === void 0 ? !0 : O, z = t.imageSmoothingQuality;
...
}, Li = V.Cropper, ke = /* @__PURE__ */ function() {
  function a(t) {
    var i = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    if (Ze(this, a), !t || !li.test(t.tagName))
      throw new Error("The first argument is required and must be an <img> or <canvas> element.");
    this.element = t, this.options = M({}, ge, ot(i) && i), this.cropped = !1, this.disabled = !1, this.pointers = {}, this.ready = !1, this.reloading = !1, this.replaced = !1, this.sized = !1, this.sizing = !1, this.init();
  }
  return qe(a, [{
    key: "init",
    value: function() {
    ...
    value: function(i) {
      ...
      if (i) {
        ...
        }, r.checkCrossOrigin && ve(i) && n.crossOrigin && (i = be(i)), o.open("GET", i, !0), o.responseType = "arraybuffer", o.withCredentials = n.crossOrigin === "use-credentials", o.send();
      }
    }
  }, {
    key: "read",
    ...
    value: function() {
      ...
      var n = V.navigator && /(?:iPad|iPhone|iPod).*?AppleWebKit/i.test(V.navigator.userAgent), r = function(l, h) {
        M(i.imageData, {
          naturalWidth: l,
          naturalHeight: h,
          aspectRatio: l / h
        }), i.initialImageData = M({}, i.imageData), i.sizing = !1, i.sized = !0, i.build();
      };
      if (e.naturalWidth && !n) {
    ...
    value: function() {
      if (!(!this.sized || this.ready)) {
        ...
        o.innerHTML = pi;
        var s = o.querySelector(".".concat(C, "-container")), p = s.querySelector(".".concat(C, "-canvas")), l = s.querySelector(".".concat(C, "-drag-box")), h = s.querySelector(".".concat(C, "-crop-box")), c = h.querySelector(".".concat(C, "-face"));
        this.container = r, this.cropper = s, this.canvas = p, this.dragBox = l, this.cropBox = h, this.viewBox = s.querySelector(".".concat(C, "-view-box")), this.face = c, p.appendChild(n), S(i, I), r.insertBefore(s, i.nextSibling), j(n, ne), this.initPreview(), this.bind(), e.initialAspectRatio = Math.max(0, e.initialAspectRatio) || NaN, e.aspectRatio = Math.max(0, e.aspectRatio) || NaN, e.viewMode = Math.max(0, Math.min(3, Math.round(e.viewMode))) || 0, S(h, I), e.guides || S(h.getElementsByClassName("".concat(C, "-dashed")), I), e.center || S(h.getElementsByClassName("".concat(C, "-center")), I), e.background && S(s, "".concat(C, "-bg")), e.highlight || S(c, ai), e.cropBoxMovable && (S(c, Wt), bt(c, vt, Zt)), e.cropBoxResizable || (S(h.getElementsByClassName("".concat(C, "-line")), I), S(h.getElementsByClassName("".concat(C, "-point")), I)), this.render(), this.ready = !0, this.setDragMode(e.dragMode), e.autoCrop && this.crop(), this.setData(e.data), k(e.ready) && Y(i, pe, e.ready, {
          once: !0
        }), ht(i, pe);
      }
    }
...
const Pi = typeof window > "u" ? [String, Array] : [String, Array, Element, NodeList], Hi = {
  render() {
    const a = this.crossorigin || void 0;
    return Jt("div", { style: this.containerStyle }, [
      Jt("img", {
        ref: "img",
        src: this.src,
        alt: this.alt || "image",
...
const Yi = We({
  ...
  setup(a, t) {
    const { ui: i } = $e(), { t: e } = Fe(), n = G(!1), r = G(), o = G(), s = G(!1), p = G(), l = G(), h = G(), c = G({
      x: 1,
      y: 1
    });
    function u() {
    ...
    const m = i.dialog.buildOnClosedBind(g), y = i.dialog.customClass, b = Dt(() => ({
      ...m,
      [y]: "fs-cropper-dialog",
    ...
    function E(d) {
      n.value = !0, d != null && d !== "" && (p.value = d);
    }
    function O() {
      n.value = !1;
    }
    function x() {
      s.value = !1, o.value != null && (o.value.value = null, o.value = null), r.value != null && r.value.clear();
    }
    function z() {
      return r.value;
    }
    ...
    function A(d) {
      return d.type.indexOf("image") === -1 ? (i.message.warn("请选择合适的文件类型"), !1) : a.maxSize > 0 && d.size / 1024 / 1024 > a.maxSize ? (i.message.warn(`图片大小超出最大限制（${a.maxSize}MB），请重新选择.`), !1) : !0;
    }
    function L(d) {
    ...
    })), Pe = Dt(() => a.uploadTip != null && a.uploadTip !== "" ? a.uploadTip : a.maxSize > 0 ? `${e("fs.extends.cropper.onlySupport")} ${a.accept.replace(/,/g, "、")},
...
const Wi = { class: "fs-cropper-dialog-wrap" }, Xi = ["accept"], Ui = { class: "fs-cropper-dialog__choose fs-cropper-dialog_left" }, ji = { class: "fs-cropper-dialog__edit fs-cropper-dialog_left" }, Vi = { class: "fs-cropper-dialog__edit-area" }, $i = { class: "tool-bar" }, Fi = { class: "fs-cropper-dialog__preview" }, Gi = { class: "fs-cropper-dialog__preview-title" }, Qi = /* @__PURE__ */ H("div", { class: "fs-cropper-dialog__preview-120 preview" }, null, -1), Zi = { class: "dialog-footer" };
function qi(a, t, i, e, n, r) {
  const o = te("fs-button"), s = te("vue-cropper");
  return Ct(), Bt(ee(a.ui.dialog.name), At({
  ...
  }, a.dialogBinding, { "destroy-on-close": !1 }), {
    footer: _t(() => [
      H("div", Zi, [
        Mt(o, {
          size: "small",
    ...
    default: _t(() => [
      H("div", Wi, [
        ...
        kt(H("div", Ui, [
          ...
          H("p", null, ie(a.computedUploadTip), 1)
        ], 512), [
          [It, !a.isLoaded]
        ]),
        kt(H("div", ji, [
          ...
          H("div", $i, [
            (Ct(), Bt(ee(a.ui.buttonGroup.name), null, {
              default: _t(() => [
                (Ct(!0), Xe(Ue, null, je(a.computedButtons, (p, l) => (Ct(), Bt(o, At({
                  key: l,
                  ref_for: !0
                }, p), null, 16))), 128))
              ]),
        ...
        H("div", Fi, [
          H("span", Gi, ie(a.computedTexts.preview), 1),
          Qi,
          H("div", {
            class: Ve(["fs-cropper-dialog__preview-65 preview", { round: a._cropper.aspectRatio === 1 }])
          }, null, 2)
        ])
      ])
    ]),
...
const ia = /* @__PURE__ */ Ge(Yi, [["render", qi]]);
export {
  ia as default
};
//# sourceMappingURL=fs-cropper-0a8836e5.mjs.map
