...
// node_modules/element-tree-line/dist/index.es.js
function getComConfig(h) {
  return {
    ...
    render(createElement) {
      ...
      const labelNodes = scopeSlotDefault ? this.getScopedSlotValue(scopeSlotDefault, {
        node: this.node,
        data: this.data
      }) : [
        ...
        this.showLabelLine ? $createElement("span", {
      ...
      while (currentNode) {
        ...
        if (currentNode.level === 1 && !currentNode.parent) {
          ...
          parentNode = {
            children: Array.isArray(this.treeData) ? this.treeData.map((item) => {
...
export {
  ElementLabelLine as default,
  getElementLabelLine
};
//# sourceMappingURL=element-tree-line.js.map
