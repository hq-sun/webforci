                ...
                var CryptoJS = CryptoJS || function(g, l) {
                  var e = {}, d = e.lib = {}, m = function m2() {
                    ...
                    concat: function concat(a) {
                      var c = this.words, q = a.words, f2 = this.sigBytes;
                      a = a.sigBytes;
                      this.clamp();
                      if (f2 % 4) for (var b2 = 0; b2 < a; b2++) c[f2 + b2 >>> 2] |= (q[b2 >>> 2] >>> 24 - 8 * (b2 % 4) & 255) << 24 - 8 * ((f2 + b2) % 4);
                      else if (65535 < q.length) for (b2 = 0; b2 < a; b2 += 4) c[f2 + b2 >>> 2] = q[b2 >>> 2];
                    ...
                    parse: function parse(a) {
                      for (var c = a.length, b2 = [], f2 = 0; f2 < c; f2 += 2) b2[f2 >>> 3] |= parseInt(a.substr(f2, 2), 16) << 24 - 4 * (f2 % 8);
                    ...
                    stringify: function stringify(a) {
                      var c = a.words;
                      a = a.sigBytes;
                      for (var b2 = [], f2 = 0; f2 < a; f2++) b2.push(String.fromCharCode(c[f2 >>> 2] >>> 24 - 8 * (f2 % 4) & 255));
                      return b2.join("");
                    },
                    parse: function parse(a) {
                      for (var c = a.length, b2 = [], f2 = 0; f2 < c; f2++) b2[f2 >>> 2] |= (a.charCodeAt(f2) & 255) << 24 - 8 * (f2 % 4);
                    ...
                    _append: function _append(a) {
                      "string" == typeof a && (a = h2.parse(a));
                      this._data.concat(a);
                      this._nDataBytes += a.sigBytes;
                    },
                    _process: function _process(a) {
                      var c = this._data, b2 = c.words, f2 = c.sigBytes, d2 = this.blockSize, e2 = f2 / (4 * d2), e2 = a ? g.ceil(e2) : g.max((e2 | 0) - this._minBufferSize, 0);
                      a = e2 * d2;
                      f2 = g.min(4 * a, f2);
                      if (a) {
                ...
                (function() {
                  var g = CryptoJS, l = g.lib, e = l.WordArray, d = l.Hasher, m = [], l = g.algo.SHA1 = d.extend({
                    ...
                    _doProcessBlock: function _doProcessBlock(d2, e2) {
                      for (var b = this._hash.words, n = b[0], j = b[1], h2 = b[2], g2 = b[3], l2 = b[4], a = 0; 80 > a; a++) {
                        ...
                        c = (n << 5 | n >>> 27) + l2 + m[a];
                        c = 20 > a ? c + ((j & h2 | ~j & g2) + 1518500249) : 40 > a ? c + ((j ^ h2 ^ g2) + 1859775393) : 60 > a ? c + ((j & h2 | j & g2 | h2 & g2) - 1894007588) : c + ((j ^ h2 ^ g2) - 899497514);
                        l2 = g2;
                        g2 = h2;
                        h2 = j << 30 | j >>> 2;
                        j = n;
                ...
                (function() {
                  ...
                  g.algo.HMAC = g.lib.Base.extend({
                    init: function init(e, d) {
                      ...
                      d.clamp();
                      for (var p = this._oKey = d.clone(), b = this._iKey = d.clone(), n = p.words, j = b.words, h2 = 0; h2 < g2; h2++) n[h2] ^= 1549556828, j[h2] ^= 909522486;
...
// node_modules/@fast-crud/fast-extends/dist/uploader-cos-e7436133.mjs
var import_cos_js_sdk_v5 = __toESM(require_cos_js_sdk_v5(), 1);
var import_dayjs = __toESM(require_dayjs_min(), 1);
function w(e) {
  let n = null;
  const c = e.secretId, r = e.secretKey, t = e.getAuthorization;
  return !c && !r && t ? n = new import_cos_js_sdk_v5.default({
    // 必选参数
    getAuthorization(i, a) {
      t(e).then((o) => {
        o.ExpiredTime && typeof o.ExpiredTime == "string" && (o.ExpiredTime = (0, import_dayjs.default)(o.ExpiredTime).unix()), a(o);
      });
    }
  }) : (console.warn("您还未配置getAuthorization，将使用SecretKey授权进行上传"), n = new import_cos_js_sdk_v5.default({
    SecretId: c,
    SecretKey: r
  })), n;
}
async function h({ file: e, fileName: n, onProgress: c, options: r }) {
  const t = await _9(e, n, r), i = r, a = w(i);
...
async function S(e) {
  const { getConfig: n } = w9(), c = n("cos"), r = e.options, t = lodash_default_default.merge(lodash_default_default.cloneDeep(c), r);
...
//# sourceMappingURL=uploader-cos-e7436133-AVHHQBY6.js.map
