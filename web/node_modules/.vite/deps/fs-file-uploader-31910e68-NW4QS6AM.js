...
// node_modules/@fast-crud/fast-extends/dist/fs-file-uploader-31910e68.mjs
var xe = defineComponent({
  ...
  setup(n, r) {
    const { ui: o } = R(), { t: c } = et(), s = ref([]), h = ref(), d = ref(), H = computed(() => n.getFileName || (async (e) => {
      if (typeof e != "string")
    ...
    function ue() {
      function e(t) {
        let i = t.value || t;
        i = lodash_default_default.cloneDeep(i);
        for (let l of i) {
          const a = I[l.id];
          a && lodash_default_default.merge(l, a);
        }
        return i;
      }
      return {
        ...
        customRequest: (t) => {
          ...
          x({
            ...
            onSuccess: async (l) => {
              ...
              l.url = await n.buildUrl(a), lodash_default_default.merge(i, l), I[i.id] = {
                ...l,
                fsRes: l
              }, t.onFinish(i);
            },
        ...
        onFinish: (t) => {
          const i = I[t.id];
          i && lodash_default_default.merge(t, i);
          const l = e(s);
          U(i, t, l);
        },
        onPreview: C
...
var Ee = Cd(xe, [["render", Ce]]);
export {
  Ee as default
};
//# sourceMappingURL=fs-file-uploader-31910e68-NW4QS6AM.js.map
