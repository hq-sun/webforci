...
// node_modules/@fast-crud/fast-extends/dist/uploader-qiniu-4628cd2f.mjs
...
async function f({ file: n, fileName: o, onProgress: a, options: e }) {
  const t = await _9(n, o, e), r = await d(n, o, t, e);
...
async function T(n) {
  const { getConfig: o } = w9(), a = o("qiniu"), e = n.options, t = lodash_default_default.merge(lodash_default_default.cloneDeep(a), e);
...
//# sourceMappingURL=uploader-qiniu-4628cd2f-JQ46N5AQ.js.map
